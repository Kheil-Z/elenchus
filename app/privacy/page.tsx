        ...
        <div className="flex flex-col gap-8 text-sm text-foreground leading-relaxed">
          ...
          <section className="flex flex-col gap-2">
            ...
            <p className="text-muted">
              ...
              provider (Anthropic, Google, or OpenAI). We coordinate shared conversations between your team and your LLMs.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <ul className="text-muted flex flex-col gap-1.5">
              ...
              <li className="flex items-start gap-2">
                <span className="mt-2 shrink-0 w-1 h-1 rounded-full bg-muted/50" />
                <span><strong className="text-foreground">Your AI provider</strong> — when you trigger an AI response, your message and any attached documents are sent to the provider you have configured (Anthropic, Google, or OpenAI) using your own API key.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="flex flex-col gap-2">
            ...
            <p className="text-muted">
              ...
              and your API key. Files you uploaded to other people&apos;s projects remain accessible to those
              teams.
            </p>
          </section>
