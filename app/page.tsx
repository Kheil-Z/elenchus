      ...
      <main className="flex-1">
        ...
        <section className="px-8 pt-20 pb-16 max-w-5xl mx-auto w-full flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <button className="bg-foreground text-surface text-sm font-medium px-5 py-2.5 rounded-lg hover:opacity-90 transition-opacity">
              Create a project
            </button>
            <button className="text-sm text-muted border border-border bg-surface px-5 py-2.5 rounded-lg hover:text-foreground transition-colors">
              Read the docs
            </button>
